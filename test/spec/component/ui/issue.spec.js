...
describeComponent('component/ui/issue', function () {
  ...
  describe("Filtering tests", function () {
    it('should hide issue', function () {
      ...
      this.setupComponent('<input type="checkbox" id="repository-0" checked="true" repo="myRepo">', {
        issue: issue
      });
    ...
    it('should not change issue if its closed', function () {
      ...
      var filteredRepo = "myRepo";
      this.setupComponent('<input type="checkbox" id="repository-0" checked="false" repo="myRepo">', {
        issue: issue
      });
      $(document).trigger("ui:dontShowRepoIssues", {
        repo: filteredRepo
